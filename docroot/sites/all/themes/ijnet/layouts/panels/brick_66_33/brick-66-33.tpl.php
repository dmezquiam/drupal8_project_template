 ...
 *
 * @see adaptivetheme_preprocess_brick_66_33()
...
<div class="at-panel panel-display two-66-33 clearfix" <?php if (!empty($css_id)): print "id=\"$css_id\""; endif; ?>>
  <div class="region region-two-66-33-first">
    <div class="region-inner clearfix">
      <?php print $content['brick_66_33_first']; ?>
    </div>
  </div>
  <div class="region region-two-66-33-second">
    <div class="region-inner clearfix">
      <?php print $content['brick_66_33_second']; ?>
    </div>
  </div>
  <div class="region region-two-66-33-first">
    <div class="region-inner clearfix">
      <?php print $content['brick_66_33_left_below']; ?>
    </div>
  </div>
  <div class="region region-two-66-33-second">
    <div class="region-inner clearfix">
      <?php print $content['brick_66_33_right_below']; ?>
    </div>
  </div>
</div>
